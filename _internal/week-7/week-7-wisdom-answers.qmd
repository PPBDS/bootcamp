...
Counter-example to the assumption of unconfoundedness:
  Unconfoundedness means that, after accounting for all covariates, winning should be independent of how long a candidate would live. If wealthier candidates are more likely to win and live longer, but wealth isn’t included in the model, the estimate for the effect of winning will be biased—because winning and lifespan are confounded by wealth.
