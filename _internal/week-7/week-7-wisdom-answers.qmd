...
1) Imagine you are a journalist in Washington, D.C., and want to forecast how long a newly elected governor might live based on their age, party, and whether they won or lost a close election. This dataset helps you make informed predictions about expected lifespan for current candidates.

2) Imagine you are a public health researcher. You want to know if winning a close election actually causes candidates to live longer than those who narrowly lose. Using this dataset, you can estimate the effect of electoral victory on longevity.
...
Scenario 1: Predictive — We are forecasting the expected lifespan of current political candidates using their personal characteristics and election outcomes.

Scenario 2: Causal — We want to estimate the causal effect of narrowly winning versus narrowly losing an election on a candidate’s lifespan, using data from close elections.

* Units:

Individual political candidates who have run in gubernatorial elections.
