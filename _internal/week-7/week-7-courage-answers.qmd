...
tribble(
  ...
  "Data", "George Wallace", "1963", "24", "Win", "3.5", "48", "67%", "Democrat", "Male", "...",
  "Data", "Nelson Rockefeller", "1959", "16", "Lose", "-9.0", "54", "80%", "Republican", "Male", "...",
  "Preceptor Table", "Pat Brown", "1959", "22", "Win", "2.9", "51", "50%", "Democrat", "Male", "...",
...
tribble(
  ...
  "Data", "George Wallace", "1963", "22", "28*", "Lose", "-3.5", "48", "67%", "Democrat", "Male", "...",
  "Data", "Nelson Rockefeller", "1959", "14*", "17", "Win", "9.0", "54", "80%", "Republican", "Male", "...",
  "Preceptor Table", "Pat Brown", "1959", "20*", "25", "Win", "2.9", "51", "50%", "Democrat", "Male", "...",
...
tribble(
  ...
  tab_spanner(label = "Outcome", columns = c(`Years Lived`)) |>
  tab_spanner(label = "Treatment", columns = c(`Election Result`)) |>
  tab_spanner(label = "Covariates", columns = c(`Win Margin`, `Age`, `Win %`, `Party`, `Other`)) |>
  cols_align(align = "center", columns = everything()) |>
  cols_align(align = "left", columns = c(`Candidate`)) |>
  fmt_markdown(columns = everything()) |>
  tab_footnote(
