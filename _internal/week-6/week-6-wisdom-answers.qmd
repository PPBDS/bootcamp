...
<!-- AT: Should I use the data summary or the backround info or both? -->
...
>**Scenario 1: “If I move some classes from 22 to 15 students, what change in average math scores should I expect next year?”**

>**Scenario 2: “If Dallas implemented small class sizes now, would we likely see similar math achievement gains as in Tennessee in the 1980s?”**

* Explore the data. What is the outcome variable? How it is distributed?
>**The main outcome is g4math, the student’s grade 4 math score (continuous, roughly normal, ~650–750).**
...
>**Refine the question to account for possible confounding, population differences, or generalizability. For example: “Would the effect be the same for minority vs. majority students, or in modern urban settings vs. 1980s Tennessee?”**
...
* Units:
>**Individual students in elementary schools. (Specify further: for scenario 1, Nashville in 2000; for scenario 2, Dallas students today.)**

* Outcome:
>**Math achievement score (e.g., 4th grade math score) for each student.**

* Covariates: 
>**class structure, sex, zip code, birth weight, family income, parent education, race, teacher experiance, school district**
    
* Treatment: 
>**assignment to a small versus regular classroom**

### Population Table Scenario 1

* Describe Population Table in words.
>**The Population Table consists of all possible combinations of elementary students and school years in Nashville for the year 2000. Each row represents a student in a given year, showing what their math score would be under both regular and small class sizes, along with other characteristics (race, prior achievement, etc.).**
...
### Population Table Scenario 2

* Describe Population Table in words.
>**The Population Table includes all possible combinations of elementary students and school years in Dallas, Texas, for the present or upcoming school year. Each row represents a Dallas student, showing their potential math scores under both regular and small class sizes, as well as student and classroom characteristics.**
