...
<!-- DK: Remove bold. Fix Chicago and date.  Make nice sentences. -->

In order to build the Preceptor Table, we need to answer some questions: Is the model causal or predictice? What are units? What are the outcomes? What are the covariates? What are the treatments?
...
* Covariates: 
>**class structure, sex, zip code, birth weight, family income, parent education, race, teacher experience, school district**
    
* Treatment: 
>**assignment to a small versus regular classroom**


<!-- DK: Insert two Preceptor Tables -->

### Population Table 

A paragraph indicating what to do. Describe in words the Population Table. For each of the four key assumption of Justice --- validity, stability, representativeness, and unconfoundedness --- provide a counter-example, if relevant.

<!-- DK: Insert two Population Tables. -->

<!-- DK: Change text to counter-examples to cover both cases, or give separate counter-examples, but probably the former, except for unconfoundedness. -->
