...
* From the [**vscode.tutorials**](https://ppbds.github.io/vscode.tutorials/) package, complete the "Code" tutorial. Make sure that you have already completed the "Introduction to R" tutorial above before you start the "Code" tutorial.
...
* From the [**vscode.tutorials**](https://ppbds.github.io/vscode.tutorials/) package, complete the "GitHub Introduction" tutorial.
...
* From the [**vscode.tutorials**](https://ppbds.github.io/vscode.tutorials/) package, complete the "GitHub Advanced" tutorial.
...
* From the [**vscode.tutorials**](https://ppbds.github.io/vscode.tutorials/) package, complete the "Quarto Websites Introduction" tutorial.
...
* From the [**vscode.tutorials**](https://ppbds.github.io/vscode.tutorials/) package, complete the "Quarto Websites Advanced" tutorial.
