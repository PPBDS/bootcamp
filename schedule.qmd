...
Identify the data which you will use for your Data Project.

## Monday 

<!-- DK: Revisit tidycensus.tutorials package. Does it work? Does it use GitHub version of tutorial.helpers for no reason in the DESCRIPTION? -->
...
* Complete the "Data Project" tutorial from the [**primer.tutorials**](https://ppbds.github.io/primer.tutorials/) package. 
